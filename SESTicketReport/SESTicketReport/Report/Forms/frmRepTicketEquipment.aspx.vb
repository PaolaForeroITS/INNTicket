...
Public Class frmRepTicketEquipment
    ...
    Private Sub GenerateReport()
        ...
        sReportName = "rptTicketEquipment"

        sql = "EXEC [dbo].[sp_TicketEquipmentRpt] " &
        ...
        Dim rdsData As ReportDataSource = New ReportDataSource("dsL01", dsData.Tables(0))
