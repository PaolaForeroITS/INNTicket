<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPages/mspDefault.Master" CodeBehind="frmRepTicketAnalytical.aspx.vb" Inherits="SESTicketReport.frmRepTicketAnalytical" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="server">
    ...
    <asp:Panel ID="pnlFilter" runat="server" Visible="true" Style ="position:relative; top: 2px; left: 25px; height: 82px; width: 975px;" BorderStyle="Ridge" BorderWidth="1px" BorderColor="#eeeeee"   >
        ...
        <asp:CheckBox ID="chkOpenByInvoice" runat="server"  Style="position: absolute; top: 42px; left: 620px; width: 22px; height: 20px; "/> 
        <asp:Label ID="lblOpenByInvoice" runat="server" Text="Open by Invoice:" CssClass="SupLabelRedBold" Style="position: absolute; top: 40px; left: 507px; width: 129px; height: 25px; text-align: left; margin-top: 4px;"/>
