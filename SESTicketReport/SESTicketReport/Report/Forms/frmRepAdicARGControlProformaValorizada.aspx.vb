...
Public Class frmRepAdicARGControlProformaValorizada
    ...
    Private Sub GenerateReport()
        ...
        Dim sOnlyDup = "No"
        If ddlOnlyDuplicate.Text = "yes" Then
            sOnlyDup = "Yes"
        End If
        ...
        If ddlShowHeader.Text = "yes" Then
            sParam = "Service Date: " & txtServiceDateBegin.Text & " - " & txtServiceDateEnd.Text & Environment.NewLine &
                 "Site ID: " & ddlSiteId.Text & "   Ticket ID: " & txtTicketID.Text & "   Only Duplicates: " & sOnlyDup & Environment.NewLine &
        ...
        sReportName = "rptAdicARGControlProformaValorizada"

        sql = "EXEC [dbo].[sp_RptTicketData] " &
                  "'Service Date'," &
