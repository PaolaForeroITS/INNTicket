...
Public Class frmRepTicketInvConsolidated
    ...
    Private Sub GenerateReport()
        ...
        sReportName = "rptTicketInvConsumptionConsolidated"

        sql = "EXEC [dbo].[sp_TicketInvConsolidated] " &
        ...
        Dim rdsData As ReportDataSource = New ReportDataSource("dsInventory", dsData.Tables(0))
