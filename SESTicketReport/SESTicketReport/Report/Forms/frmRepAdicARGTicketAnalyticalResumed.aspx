<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPages/mspDefault.Master" CodeBehind="frmRepAdicARGTicketAnalyticalResumed.aspx.vb" Inherits="SESTicketReport.frmRepAdicARGTicketAnalyticalResumed" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="server">
    ...
    <%-- Filter Area --%>
    <asp:Panel ID="pnlFilter" runat="server" Visible="true" Style ="position:relative; top: 2px; left: 5px; height: 100px; width: 1100px;" BorderStyle="Ridge" BorderWidth="1px" BorderColor="#eeeeee"   >
        ...
        <asp:Panel ID="pnlCol3" runat="server" Style="position: absolute; top: 10px; left: 470px; " >

            <asp:Label ID="Label1" runat="server" Text="Site:" CssClass="SupLabelBlueBold" Style="position: absolute; top: 0px; left: 5px; width: 103px; height: 25px; text-align: right; margin-top: 4px;"/>
            <asp:DropDownList ID="ddlSiteId" runat="server" CssClass="form-control" Style ="position: absolute; top: 0px; left: 120px; width: 150px;" 
                 DataSourceID ="SITEds"  DataValueField="SITEID" DataTextField="SITENAME" ></asp:DropDownList>
            <asp:SqlDataSource ID="SITEds" runat="server" ConnectionString="<%$ ConnectionStrings:SESTicketSQLConnStr %>" 
                SelectCommand="SELECT 'ALL' AS SITEID,'ALL' AS SITENAME UNION ALL SELECT SITEID, SITEID + ' - ' + NAME FROM SITE ORDER BY 2 "></asp:SqlDataSource>


            <asp:Label ID="Label2" runat="server" Text="Service Line:" CssClass="SupLabelBlueBold" Style="position: absolute; top: 35px; left: 5px; width: 103px; height: 25px; text-align: right; margin-top: 4px;"/>
            <asp:DropDownList ID="ddlServiceLineID" runat="server" CssClass="form-control" Style ="position: absolute; top: 40px; left: 120px; width: 150px;"
                 DataSourceID ="SERVICELINEds"  DataValueField="SERVICELINEID" DataTextField="SERVICELINENAME" ></asp:DropDownList>
            <asp:SqlDataSource ID="SERVICELINEds" runat="server" ConnectionString="<%$ ConnectionStrings:SESTicketSQLConnStr %>" 
                SelectCommand="SELECT 0 AS SERVICELINEID,'ALL' AS SERVICELINENAME UNION ALL SELECT SERVICELINEID, NAME FROM SERVICELINE ORDER BY 2 "></asp:SqlDataSource>



        </asp:Panel>

        <asp:Panel ID="pnlTicketStatus" runat="server" Style="position: absolute; top: 10px; left: 770px; width: 129px; height: 25px; " >
            ...
            <asp:CheckBox ID="chkCanceled" runat="server"  Style="position: absolute; top: 2px; left: 230px; width: 22px; height: 20px; " Checked="True"/> 
        ...
        <asp:Label ID="lblShowHeader" runat="server" Text="Show Header:" CssClass="SupLabelBlueBold" Style="position: absolute; top: 40px; left: 755px; width: 103px; height: 25px; text-align: right; margin-top: 4px;"/>
        <asp:DropDownList ID="ddlShowHeader" runat="server" CssClass="form-control" Style ="position: absolute; top: 42px; left: 876px; width: 80px;">
                <asp:ListItem Text="Yes" Value="yes" Selected="True"></asp:ListItem>
                <asp:ListItem Text="No" Value="no"></asp:ListItem>
            </asp:DropDownList>

        <asp:Button ID="btnGenReport" runat="server" Text="Ok" CssClass="btn btn-primary btn-sm"  Style="position: absolute; top: 42px; left: 980px; width: 70px;" OnClick="btnGeneReport_Click" />
