...
Public Class frmRepTicketHSEQServEval
    ...
    Private Sub GenerateReport()
        ...
        sReportName = "rptTicketHSEQServiceEvalution"

        sql = "EXEC [dbo].[sp_TicketHSEQServiceEvalution] " &
        ...
        Dim rdsData As ReportDataSource = New ReportDataSource("dsHSEQ", dsData.Tables(0))
