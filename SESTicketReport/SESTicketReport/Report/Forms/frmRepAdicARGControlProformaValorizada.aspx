<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPages/mspDefault.Master" CodeBehind="frmRepAdicARGControlProformaValorizada.aspx.vb" Inherits="SESTicketReport.frmRepAdicARGControlProformaValorizada" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="server">
    ...
    <%-- Filter Area --%>
    <asp:Panel ID="pnlFilter" runat="server" Visible="true" Style ="position:relative; top: 2px; left: 25px; height: 82px; width: 1000px;" BorderStyle="Ridge" BorderWidth="1px" BorderColor="#eeeeee"   >
        ...
        <asp:Label ID="lblSiteId" runat="server" Text="Site ID:" CssClass="SupLabelBlueBold" Style="position: absolute; top: 40px; left: 250px; width: 103px; height: 25px; text-align: right; margin-top: 4px;"/>
        <asp:DropDownList ID="ddlSiteId" runat="server" CssClass="form-control" Style ="position: absolute; top: 42px; left: 360px; width: 129px;" 
        ...
        <asp:Label ID="lblShowHeader" runat="server" Text="Show Header:" CssClass="SupLabelBlueBold" Style="position: absolute; top: 40px; left: 505px; width: 103px; height: 25px; text-align: right; margin-top: 4px;"/>
        <asp:DropDownList ID="ddlShowHeader" runat="server" CssClass="form-control" Style ="position: absolute; top: 42px; left: 620px; width: 80px;">
                <asp:ListItem Text="Yes" Value="yes" Selected="True"></asp:ListItem>
                <asp:ListItem Text="No" Value="no"></asp:ListItem>
            </asp:DropDownList>
        <asp:Label ID="lblOnlyDuplicates" runat="server" Text="Only Duplicates:" CssClass="SupLabelBlueBold" Style="position: absolute; top: 40px; left: 715px; width: 103px; height: 25px; text-align: right; margin-top: 4px;"/>
        <asp:DropDownList ID="ddlOnlyDuplicate" runat="server" CssClass="form-control" Style ="position: absolute; top: 42px; left: 825px; width: 80px;">
                <asp:ListItem Text="Yes" Value="yes" ></asp:ListItem>
                <asp:ListItem Text="No" Value="no" Selected="True"></asp:ListItem>
            </asp:DropDownList>


        <asp:Button ID="btnGenReport" runat="server" Text="Ok" CssClass="btn btn-primary btn-sm"  Style="position: absolute; top: 10px; left: 920px; width: 70px;" OnClick="btnGeneReport_Click" />
