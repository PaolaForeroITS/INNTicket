...
Public Class frmRepAdicARGTicketAnalyticalResumed
    ...
    Private Sub GenerateReport()
        ...
        If ddlSiteId.SelectedValue.ToString <> "ALL" Then
            sSiteId = ddlSiteId.SelectedValue.ToString
        End If
        If ddlServiceLineID.SelectedValue.ToString <> "0" Then
            sServiceLineId = ddlServiceLineID.SelectedValue.ToString
        End If
        ...
        Dim sParam As String = "no"
        If ddlShowHeader.Text = "yes" Then
            sParam = "Service Date: " & txtServiceDateBegin.Text & " - " & txtServiceDateEnd.Text & Environment.NewLine &
                 "Created By: " & sCreatedBy & "       Ticket ID: " & txtTicketID.Text & Environment.NewLine &
                 "Ticket Status: " & sTicketStatus & Environment.NewLine &
                 "Site: " & ddlSiteId.SelectedValue.ToString & Environment.NewLine &
                 "ServiceLine: " & ddlServiceLineID.SelectedItem.ToString()
        End If
        Dim myParam As New ReportParameter("headerParam", sParam)
        ...
        sReportName = "rptAdicARGTicketAnalyticalResumed"

        sql = "EXEC [dbo].[sp_TicketHeaderRpt] " &
                  ...
                  "" & util.SQLConvStrNull(sSiteId, "s") & "," &
                  "" & util.SQLConvStrNull(sServiceLineId, "n")
        ...
        With ReportViewer1
            ...
            .LocalReport.SetParameters(myParam)
        End With
