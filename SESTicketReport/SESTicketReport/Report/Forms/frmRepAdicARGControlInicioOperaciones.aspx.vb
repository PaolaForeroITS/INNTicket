...
Public Class frmRepAdicARGControlInicioOperaciones
    ...
    Private Sub GenerateReport()
        ...
        If ddlShowHeader.Text = "yes" Then
            sParam = "Service Date: " & txtServiceDateBegin.Text & " - " & txtServiceDateEnd.Text & Environment.NewLine &
                 "Site ID: " & ddlSiteId.Text & "       Ticket ID: " & txtTicketID.Text & Environment.NewLine &
        ...
        sReportName = "rptAdicARGControlInicioOperaciones"
