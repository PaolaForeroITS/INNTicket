Public Class frmRPTModel03LetterPortraitPageBreak
    Public sTicketId As String
    Public sReportParamId As String
    Public sItemType As String
    Private Sub frmRPTModel03LetterPortraitPageBreak_Load(sender As Object, e As EventArgs) Handles MyBase.Load
