Public Class frmRPTDefault01LetterPortraitPageBreak
    Public sTicketId As String
    Public sReportParamId As String

    Private Sub frmRPTDefault01LetterPortraitPageBreak_Load(sender As Object, e As EventArgs) Handles MyBase.Load
