Public Class frmRPTDefault01LetterLandscapePageBreak
    Public sTicketId As String
    Public sReportParamId As String

    Private Sub frmRPTDefault01LetterLandscapePageBreak_Load(sender As Object, e As EventArgs) Handles MyBase.Load
