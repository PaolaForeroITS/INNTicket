Public Class frmRPTTicketHSEQServiceEvalution
    Dim util As New clsUtils
    Private Sub frmRPTTicketHSEQServiceEvalution_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'SESTicketSQLDataSet.TICKETHSEQ_V' table. You can move, or remove it, as needed.
        Me.TICKETHSEQ_VTableAdapter.Fill(Me.SESTicketSQLDataSet.TICKETHSEQ_V)
    ...
    Private Sub GenerateReport()
        ...
        TICKETHSEQ_VBindingSource.Filter = sfilter
