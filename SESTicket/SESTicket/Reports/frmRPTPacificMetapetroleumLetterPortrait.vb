Public Class frmRPTPacificMetapetroleumLetterPortrait
    Public sTicketId As String
    Public sReportParamId As String

    Private Sub frmRPTPacificMetapetroleumLetterPortrait_Load(sender As Object, e As EventArgs) Handles MyBase.Load
