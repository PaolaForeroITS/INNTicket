...
Partial Class frmTicketInvConsumptionLetterLandscape
    ...
    Private Sub InitializeComponent()
        ...
        Me.REPORTINVLINE_VTableAdapter = New INNTicket.SESTicketAccessDataSetTableAdapters.REPORTINVLINE_VTableAdapter()
        Me.REPORTPARAMTableAdapter = New INNTicket.SESTicketAccessDataSetTableAdapters.REPORTPARAMTableAdapter()
        Me.TICKETINVADICTableAdapter = New INNTicket.SESTicketAccessDataSetTableAdapters.TICKETINVADICTableAdapter()
