Public Class frmRPTModel02LetterPortraitPageBreak
    Public sTicketId As String
    Public sReportParamId As String

    Private Sub frmRPTModel02LetterPortraitPageBreak_Load(sender As Object, e As EventArgs) Handles MyBase.Load
