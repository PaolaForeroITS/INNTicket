Public Class frmRPTEcopetrolMaterialLetterPageBreak
    Public sTicketId As String
    Public sReportParamId As String

    Private Sub frmRPTEcopetrolMaterialLetterPageBreak_Load(sender As Object, e As EventArgs) Handles MyBase.Load
