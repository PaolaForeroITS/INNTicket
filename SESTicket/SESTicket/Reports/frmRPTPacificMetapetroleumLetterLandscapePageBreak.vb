Public Class frmRPTPacificMetapetroleumLetterLandscapePageBreak
    Public sTicketId As String
    Public sReportParamId As String

    Private Sub frmRPTPacificMetapetroleumLetterLandscapeBreakPage_Load(sender As Object, e As EventArgs) Handles MyBase.Load
