Public Class frmRPTModel02LetterLandscapePageBreak
    Public sTicketId As String
    Public sReportParamId As String

    Private Sub frmRPTModel02LetterLandscapePageBreak_Load(sender As Object, e As EventArgs) Handles MyBase.Load
