Public Class frmRPTEcopetrolServiceLetterPageBreak
    Public sTicketId As String
    Public sReportParamId As String

    Private Sub frmRPTEcopetrolServiceLetterPageBreak_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If IsNothing(sReportParamId) = False Then
            ...
            sFilter = sFilter & " AND ITEMTYPE='Service'"
