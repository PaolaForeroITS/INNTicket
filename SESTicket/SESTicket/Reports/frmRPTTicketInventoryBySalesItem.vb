Public Class frmRPTTicketInventoryBySalesItem

    Dim util As New clsUtils

    Private Sub frmRPTTicketInventoryAnalytical_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub GenerateReport()
        ...
        Me.sp_TicketInventoryTableAdapter.Fill(Me.SESTicketSQLDataSet.sp_TicketInventory, dServiceDateBegin, dServiceDateEnd, sTicketStatus)
