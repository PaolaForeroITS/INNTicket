Public Class frmRPTPacificMetapetroleumLetterLandscape
    Public sTicketId As String
    Public sReportParamId As String

    Private Sub frmRPTPacificMetapetroleumLetter_Load(sender As Object, e As EventArgs) Handles MyBase.Load
