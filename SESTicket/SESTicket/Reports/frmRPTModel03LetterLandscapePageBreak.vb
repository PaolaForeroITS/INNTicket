Public Class frmRPTModel03LetterLandscapePageBreak
    Public sTicketId As String
    Public sReportParamId As String
    Public sItemType As String

    Private Sub frmRPTModel03LetterLandscapePageBreak_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        If IsNothing(sReportParamId) = True Then
            Exit Sub
        End If
        ...
        REPORTLINE_VBindingSource.Filter = sFilter & " AND ITEMTYPE='" & sItemType & "'"
