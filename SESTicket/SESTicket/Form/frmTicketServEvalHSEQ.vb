Public Class frmTicketServEvalHSEQ
    ...
    Private Sub EcopetrolToolStripMenuItem_Click(sender As Object, e As EventArgs)
    ...
    Private Sub EcopetrolToolStripMenuPrint_Click(sender As Object, e As EventArgs)
